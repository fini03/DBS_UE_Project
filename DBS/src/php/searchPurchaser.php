...
$purchaser_id = $first_name = $last_name = $email_address = null;
$purchaser_array = '';
$success = '';
...
<html lang="en">
    ...
    <body>
        ...
        <section>
            <?php if(!($database->emptyString($purchaser_id))||!($database->emptyString($first_name))||!($database->emptyString($last_name))||!($database->emptyString($email_address))) { $purchaser_array = $database->adSearchPurchaser($purchaser_id,
            $first_name, $last_name, $email_address, $success); if($success && !empty($purchaser_array)) { ?>
            <div class="container">
                <div class="row">
                    <h4>Purchaser Search Result:</h4>
                    <table class="table">
                        <thead>
                            <tr>
                                <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <t style="color: red;"><?php echo "Purchaser not found!"; ?></t>
                </div>
            </div>
            <?php
        }
        ...
        <section>
            <div class="container">
                <div class="row">
                    <h2>Search Purchaser Form</h2>
                </div>
                <form method="post" action="searchPurchaser.php">
                    ...
                    <div>
                        <button class="button"><span>Search Purchaser</span></button>
                    </div>
                </form>
            </div>
        </section>
