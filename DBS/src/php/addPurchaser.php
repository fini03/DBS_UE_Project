...
<html lang="en">
    ...
    <body>
        ...
        <section>
            <?php
// Check result
if(!($database->emptyString($first_name))&&!($database->emptyString($last_name))&&!($database->emptyString($email_address))) { $purchaser_array = $database->insertIntoPurchaser ($first_name, $last_name, $email_address, $success);
            if($success){ ?>
            <div class="container">
                <div class="row">
                    <h4>Purchaser has been added!</h4>
                    <table class="table">
                        <thead>
                            <tr>
                                <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <t style="color: red;"><?php echo "Error can't insert Purchaser '{$first_name} {$last_name} {$email_address}'!"; ?></t>
                </div>
            </div>
            <?php
        }
        ...
        <section>
            ...
            <div class="container">
                <div class="row">
                    <h2>Add Purchaser Form</h2>
                </div>
                <form method="post" action="addPurchaser.php">
                    <div>
                    ...
                    <div>
                        <button class="button"><span>Add Purchaser</span></button>
                    </div>
                </form>
            </div>
        </section>
