...
$employee_id = $first_name = $last_name = $email_address = $phone_number = $supervisor_id = '';
$success = '';
$help = false;
...
<section>
  ...
  <body>
    <?php
    if (!($database->emptyString($employee_id))) {
      $database->updateEmployee($employee_id, $first_name, $last_name, $email_address, $phone_number, $supervisor_id, $success);
      $employee_array = $database->searchEmployee($employee_id);
      if
      ($success && !empty($employee_array)) { ?>
        <div class="container">
          <div class="row">
            <h4>Employee successfully updated!</h4>
            <table class="table">
              <thead>
                <tr>
                  <div class="container">
        ...
        <div class="container">
          <div class="row">
            <t style="color: red;">
              <?php echo "Error can't update Employee with ID: '{$employee_id}'!"; ?>
            </t>
          </div>
        </div>
        <?php
    ...
    <section>
      <div class="container">
        ...
        <form method="post" action="updateEmployee.php">
          ...
          <div>
            <button class="button"><span>Update Employee</span></button>
          </div>
        </form>
      </div>
    </section>
