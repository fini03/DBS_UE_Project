...
$first_name = $last_name = $email_address = $phone_number = $supervisor_id = '';
$employee_array = '';
$success = '';
$help = false;
...
<html lang="en">
    ...
    <body>
        ...
        <section>
            <?php
            if(!($database->emptyString($first_name))&&!($database->emptyString($last_name))&&!($database->emptyString($email_address))&&!($database->emptyString($phone_number))) { $employee_array = $database->insertIntoEmployee
            ($first_name, $last_name, $email_address, $phone_number, $supervisor_id, $success); if($success){ ?>
            <div class="container">
                <div class="row">
                    <h4>Employee has been added!</h4>
                    <table class="table">
                        <thead>
                            <tr>
                                <div class="container">
                            ...
                            <tr>
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <td>
                                            <div class="col">
                                                <a href="Employee.php?employee_id=<?php echo $employee['SUPERVISOR_ID'] ?>"> <?php echo $employee['SUPERVISOR_ID']; ?></a>
                                            </div>
                                        </td>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <t style="color: red;"><?php echo "Error can't insert Employee '{$first_name} {$last_name} {$email_address} {$phone_number} {$supervisor_id}'!"; ?></t>
                </div>
            </div>
            <?php
            }
        ...
        <section>
            <div class="container">
                ...
                <form method="post" action="addEmployee.php">
                    ...
                    <br />
                    <div>
                        <label for="new_phone_number">Phone number<sup style="color: red;">*</sup></label>
                    </div>
                    <br />
                    <div><input id="new_phone_number" name="phone_number" type="text" maxlength="100" placeholder="Your phone number" /></div>
                    <br />
                    ...
                    <div>
                        <button class="button"><span>Add Employee</span></button>
                    </div>
                </form>
            </div>
        </section>
